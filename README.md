...
1. Explain the difference between `Relational Databases` and `SQL`.
    ...
    SQL is the overall format of the data, and a relational database is an example of SQL, but has multiple tables perhaps connected with a foreign key.

2. Why do tables need a `primary key`?

    To identify the row entries and define the row by something unique.
...
4. What do we need in order to have a _many to many_ relationship between two tables.
    ...
    An extra intermediary table with the primary key id's from the other two tables
...
-   [ ] Build an API with endpoints for:
    -   [x] adding resources. - post  /api/resources
    -   [x] retrieving a list of resources. - get   /api/resources
    -   [x] adding projects. -post                  /api/projects
    -   [x] retrieving a list of projects. - get        /api/projects
    -   [x] adding tasks. - post                    /api/projects/:id/tasks
    -   [x] retrieving a list of tasks. - get      /api/projects/:id/tasks
    **The list of tasks should include the project name and project description**. -- use join in knex
